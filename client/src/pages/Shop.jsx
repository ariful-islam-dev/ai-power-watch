...
const Shop = () => {
  const [isDrawerOpen, setIsMenuOpen] = React.useState(false);

  const toggleMenu = () => {
    setIsMenuOpen(!isDrawerOpen);
  };
  return (
      ...
      <div>
        <div className="relative">
          ...
          <div
            ...
            // className={`fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform bg-white w-64 dark:bg-gray-800 -translate-x-full`}
            className={`absolute top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform bg-white w-64 dark:bg-gray-800 ${
              isDrawerOpen
